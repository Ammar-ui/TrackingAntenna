...
const char * udpAddress = "192.168.4.12";
...
//    Serial.println(" hPa");
    ...
    Serial.print(bmp.readAltitude(1015)); //The "1019.66" is the pressure(hPa) at sea level in day in your region
    Serial.println(" m");                    //If you don't know it, modify it until you get your current altitude

    Serial.println();
    float high=bmp.readAltitude(1015);
